...
- 公开网页：https://he1met.github.io/research-tree-lab/ 。当前已实测 snapshot 为 b8633ae1ad392b613c312e0754b472a0eace2ef3fb9caa2c3e4075114411679a；56 个远端 HTTP 资源及浏览器实际页面核对通过，见 `docs/current-publication.json`。
