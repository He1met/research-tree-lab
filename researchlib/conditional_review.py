...
APPROVED_WAITING_HASH = 'd21b004a0efe4295f391a3f82ccba05f6a967b9205d370eabd807a8692f91f65'
MAX_SOURCES = 4
MAX_EVENTS = 20_000
...
PUBLIC_SCANNER_SOURCE_HASH = '514263bb4038d7d1b1548f31ba9d3d00d67c0f0410990456fc9f02e85e9fd063'
PUBLIC_SCANNER_GIT_URL = 'https://github.com/He1met/research-tree-lab/blob/9a5259b7c72c1b3d40ad4b11ae2e28210252d9a0/researchlib/public.py'
...
def method_material(prepared_at):
    ...
    method['public_archive'] = {'self_contained_method_restore': False,
        'excluded_source_attachments': [{'path': 'SOURCE/researchlib/public.py', 'sha256': PUBLIC_SCANNER_SOURCE_HASH,
            'reason': 'SCANNER_SELF_MATCHES_OWN_PRIVATE_PATH_REGEX', 'published_git_source': PUBLIC_SCANNER_GIT_URL}],
...
def _previous_node(store, previous, plan, records, metadata, current_method, context):
    ...
    if material.get('method_version') == waiting.VERSION:
        expected, _ = waiting.method_material(previous['available_at'])
        if expected['method_code_sha256'] != APPROVED_WAITING_HASH or material != expected:
        ...
        evaluator = waiting.VERSION + '@sha256:' + APPROVED_WAITING_HASH
